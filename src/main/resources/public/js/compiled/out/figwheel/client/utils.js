...
return (new CustomEvent(event_name,(function (){var obj30062 = {"detail":data};
return obj30062;
})()));
} else {
...
var f = (function (){var pred__30069 = cljs.core._EQ_;
var expr__30070 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__30069.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__30070))){
return ((function (pred__30069,expr__30070){
return (function (p1__30063_SHARP_){
return console.warn(p1__30063_SHARP_);
});
;})(pred__30069,expr__30070))
} else {
if(cljs.core.truth_(pred__30069.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__30070))){
return ((function (pred__30069,expr__30070){
return (function (p1__30064_SHARP_){
return console.debug(p1__30064_SHARP_);
});
;})(pred__30069,expr__30070))
} else {
if(cljs.core.truth_(pred__30069.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__30070))){
return ((function (pred__30069,expr__30070){
return (function (p1__30065_SHARP_){
return console.error(p1__30065_SHARP_);
});
;})(pred__30069,expr__30070))
} else {
return ((function (pred__30069,expr__30070){
return (function (p1__30066_SHARP_){
return console.log(p1__30066_SHARP_);
});
;})(pred__30069,expr__30070))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__30073){
...
var opts = map__30074__$1;
var eval_fn = cljs.core.get.call(null,map__30074__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__30076_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__30078,(0),null);
...
}catch (e30083){if((e30083 instanceof Error)){
var e = e30083;
return not_found;
} else {
throw e30083;
...
//# sourceMappingURL=utils.js.map?rel=1539578344973
